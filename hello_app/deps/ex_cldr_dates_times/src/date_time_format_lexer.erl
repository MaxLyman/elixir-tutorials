...
-module(date_time_format_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/date_time_format_lexer.xrl", 116).
...
-file("src/date_time_format_lexer.erl", 347).
yystate() -> 45.

yystate(46, [124|Ics], Line, Col, Tlen, _, _) ->
    yystate(46, Ics, Line, Col, Tlen+1, 40, Tlen);
yystate(46, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(46, Ics, Line+1, 1, Tlen+1, 40, Tlen);
yystate(46, [C|Ics], Line, Col, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(46, Ics, Line, Col, Tlen+1, 40, Tlen);
yystate(46, [C|Ics], Line, Col, Tlen, _, _) when C >= 11, C =< 38 ->
    yystate(46, Ics, Line, Col, Tlen+1, 40, Tlen);
yystate(46, [C|Ics], Line, Col, Tlen, _, _) when C >= 40, C =< 64 ->
    yystate(46, Ics, Line, Col, Tlen+1, 40, Tlen);
yystate(46, [C|Ics], Line, Col, Tlen, _, _) when C >= 91, C =< 96 ->
    yystate(46, Ics, Line, Col, Tlen+1, 40, Tlen);
yystate(46, [C|Ics], Line, Col, Tlen, _, _) when C >= 126 ->
    yystate(46, Ics, Line, Col, Tlen+1, 40, Tlen);
...
yystate(45, [122|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(33, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [121|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(45, [119|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(27, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [118|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(25, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [117|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(23, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [115|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(45, [113|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [109|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [107|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(13, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [104|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(45, [100|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(7, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [99|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [98|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(45, [90|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [89|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [88|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [87|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [86|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [85|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [83|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [81|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [79|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [77|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [76|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(20, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [75|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(22, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [72|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [71|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(26, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [70|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(45, [68|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(32, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [66|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(34, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [65|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(45, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(46, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(46, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 40, C =< 64 ->
    yystate(46, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 91, C =< 96 ->
    yystate(46, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(42, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(42, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 40 ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(38, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 40 ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(38, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,38};
yystate(37, [125|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(20, [76|Ics], Line, Col, Tlen, _, _) ->
...
yystate(15, [109|Ics], Line, Col, Tlen, _, _) ->
...
yystate(13, [107|Ics], Line, Col, Tlen, _, _) ->
    yystate(13, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(13, Ics, Line, Col, Tlen, _, _) ->
    {25,Tlen,Ics,Line,Col,13};
yystate(12, [83|Ics], Line, Col, Tlen, _, _) ->
    yystate(12, Ics, Line, Col, Tlen+1, 29, Tlen);
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {29,Tlen,Ics,Line,Col,12};
yystate(11, [104|Ics], Line, Col, Tlen, _, _) ->
    yystate(11, Ics, Line, Col, Tlen+1, 23, Tlen);
yystate(11, Ics, Line, Col, Tlen, _, _) ->
    {23,Tlen,Ics,Line,Col,11};
yystate(10, [85|Ics], Line, Col, Tlen, _, _) ->
...
yystate(8, [86|Ics], Line, Col, Tlen, _, _) ->
    yystate(8, Ics, Line, Col, Tlen+1, 35, Tlen);
...
yystate(6, [87|Ics], Line, Col, Tlen, _, _) ->
...
yystate(5, [99|Ics], Line, Col, Tlen, _, _) ->
    yystate(5, Ics, Line, Col, Tlen+1, 19, Tlen);
yystate(5, Ics, Line, Col, Tlen, _, _) ->
    {19,Tlen,Ics,Line,Col,5};
yystate(4, [88|Ics], Line, Col, Tlen, _, _) ->
    yystate(4, Ics, Line, Col, Tlen+1, 36, Tlen);
yystate(4, Ics, Line, Col, Tlen, _, _) ->
    {36,Tlen,Ics,Line,Col,4};
yystate(3, [98|Ics], Line, Col, Tlen, _, _) ->
    yystate(3, Ics, Line, Col, Tlen+1, 21, Tlen);
yystate(3, Ics, Line, Col, Tlen, _, _) ->
    {21,Tlen,Ics,Line,Col,3};
yystate(2, [89|Ics], Line, Col, Tlen, _, _) ->
...
yystate(1, [97|Ics], Line, Col, Tlen, _, _) ->
    yystate(1, Ics, Line, Col, Tlen+1, 20, Tlen);
yystate(1, Ics, Line, Col, Tlen, _, _) ->
    {20,Tlen,Ics,Line,Col,1};
yystate(0, [90|Ics], Line, Col, Tlen, _, _) ->
    yystate(0, Ics, Line, Col, Tlen+1, 32, Tlen);
