{application,ex_cldr,
             [{compile_env,[{ex_cldr,[json_library],error}]},
              {optional_applications,[jason,nimble_parsec,gettext]},
              {applications,[kernel,stdlib,elixir,logger,inets,ssl,eex,
                             ex_unit,cldr_utils,decimal,jason,nimble_parsec,
                             gettext]},
              ...
              {modules,['Elixir.Cldr','Elixir.Cldr.AcceptLanguage',
                        ...
                        'Elixir.Cldr.Type','Elixir.Cldr.UnknownBackendError',
                        ...
                        'Elixir.Cldr.Validity.U','Elixir.Cldr.Validity.Unit',
